<?
    ...
    $user = 'TRO2012'; // place SG username here
    $pass = 'TheGrove$1017'; // place SG password here
    ...
    $params = array(
        'api_user'  => "$user",
        'api_key'   => "$pass",
        'to'        => "downtowndj@gmail.com", // set TO address to have the contact form's email content sent to
        ...
        'text'      => "
            ...
            Subject: $subject\n
            $message",
        'from'      => "chrisb@travmarket.com", // set from address here, it can really be anything
    );
